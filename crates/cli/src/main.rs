...
/// Build [`wkhtmltopdf_settings::PdfGlobal`] from the parsed CLI arguments.
...
/// Build a [`wkhtmltopdf_settings::PdfObject`] that represents a generated Table of Contents page.
///
...
/// [`wkhtmltopdf_settings::UnitReal`].  Falls back to millimetres when no unit suffix is recognised.
